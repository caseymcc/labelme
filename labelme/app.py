...
class MainWindow(QtWidgets.QMainWindow):
        ...
        if filename.lower().endswith('.json'):
            ...
            if self._config['directory_config']:
                ...
                if self.directoryConfig['label_directory']:
                    label_path=osp.join(label_path, self.directoryConfig['label_directory'])
                ...
                if self.directoryConfig['label_file_prefix']:
                    label_filename=self.directoryConfig['label_file_prefix']+label_filename
                if self.directoryConfig['label_file_postfix']:
                    label_filename=label_filename+self.directoryConfig['label_file_postfix']
    ...
    def openDirDialog(self, _value=False, dirpath=None):
        ...
        if self._config['directory_config']:
            ...
            self.directoryConfig=get_directory_config(self._config, directoryConfigPath)
            
            self.output_dir=targetDirPath
            if self.directoryConfig['output_directory']:
                self.output_dir=targetDirPath=self.config['output_directory']
    ...
    def importDirImages(self, dirpath, pattern=None, load=True):
        ...
        imagepath=dirpath
        if self._config['directory_config'] and self.directoryConfig['image_directory']:
            imagepath=osp.join(dirpath, self.directoryConfig['image_directory'])
